...
document.addEventListener('DOMContentLoaded', () => {
    ...
    updateAuthUI();
    // initAnnouncements(); // Server-side rendered directly via Blade
    initSafeguarding();
    initContact();
    // initHomeResources(); // Server-side rendered directly via Blade
    initNotifications();
    // initCalendar(); // Server-side rendered directly via Blade
...
function filterResources(cat, btn) {
    ...
    const cards = document.querySelectorAll('.resource-card-home');
    cards.forEach(card => {
